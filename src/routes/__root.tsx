  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Neural Soft — Custom Software, AI & Enterprise Solutions" },
      {
        ...
        content:
          "AI, ERP, HRMS, web, mobile, cloud, and cybersecurity for mid-to-large enterprises. 100+ projects delivered.",
      },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Neural Soft — Custom Software, AI & Enterprise Solutions" },
      {
        name: "twitter:description",
        content: "Engineering the future with AI & enterprise software.",
      },
      ...
      { property: "og:image", content: "/images/neural-soft-logo.jpeg" },
      { name: "twitter:image", content: "/images/neural-soft-logo.jpeg" },
    ],
    links: [
