import { Brain, Building, Code2, Smartphone, Cloud, ShieldCheck, type LucideIcon } from "lucide-react";
...
const services: Service[] = [
  ...
  { icon: ShieldCheck, title: "Cyber Security", tech: "VAPT · Security Audit · Compliance", desc: "End-to-end security posture reviews, penetration testing, and ISO/SOC-aligned hardening." },
];
