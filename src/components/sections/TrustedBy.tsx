...
const petraUrl = "/images/petra.png";
const caritasUrl = "/images/caritas.png";
const media365Url = "/images/media365.webp";
const dblPharmaUrl = "/images/dbl-pharma.jpg";
const shodeshUrl = "/images/shodesh.webp";

const logos = [
  { src: petraUrl, alt: "Petra" },
  { src: caritasUrl, alt: "Caritas Bangladesh" },
  { src: media365Url, alt: "Media365" },
  { src: dblPharmaUrl, alt: "DBL Pharma" },
  { src: shodeshUrl, alt: "Shodesh Group" },
];
